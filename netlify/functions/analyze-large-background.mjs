...
{"likeScore": 數字或null, "likeScale": 數字, "understandScore": 數字或null, "understandScale": 數字, "foundation": [{"text":"...","page":3}], "school": [{"text":"...","page":null}], "instructor": [{"text":"...","page":5}], "competencies": [{"name":"覺察力","evidence":"..."}], "illustrationPages": [頁碼]}`;
